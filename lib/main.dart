...
class _HomeScreenState extends State<HomeScreen> {
            ...
            children: [
              ...
              const Column(
                ...
                children: [
                  ...
                  Text("Медиа-центр • Без сжатия и без рекламы", style: TextStyle(fontSize: 12, color: ObanColors.textSecondary)),
                ],
              ),
            ],
          ),
  ...
  Widget _buildQueueCard(DownloadItem item) {
    ...
    if (item.status == DownloadStatus.downloading) {
      ...
      statusLabel = "Скачивание ${(item.progress * 100).toInt()}%";
...
// ─────────────────────────────────────────────
// 2. МОДАЛЬНОЕ ОКНО ПРИ НАЖАТИИ «ПОДЕЛИТЬСЯ»
// ─────────────────────────────────────────────
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  child: const Text("Аудио (MP3)", style: TextStyle(color: Colors.white)),
                ),
              ),
            ],
          ),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              QueueManager.instance.add(DownloadItem(
                ...
                title: "Медиа из буфера...",
                isAudio: _isAudio,
                quality: _quality,
              ));
              Navigator.pop(context);
            },
            child: const Text("СКАЧАТЬ СЕЙЧАС", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          ),
        ],
      ),
    );
...
// ─────────────────────────────────────────────
// 3. ЭКРАН ФАЙЛОВ И ВСТРОЕННЫЙ ПРОСМОТРЩИК
// ─────────────────────────────────────────────
...
// ─────────────────────────────────────────────
// 4. НАСТРОЙКИ, ПАМЯТЬ И РАЗРЕШЕНИЯ
// ─────────────────────────────────────────────
    ...
    return SafeArea(
      child: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                const Text("Доступ к Музыке, Галерее и уведомлениям.", style: TextStyle(color: ObanColors.textSecondary, fontSize: 13)),
                const SizedBox(height: 14),
                Row(
                  children: [
                    ElevatedButton(
          ...
          const SizedBox(height: 12),
          _devCard("Курбонов Б.", "Основатель & Lead System Architect", "Разработка сетевого ядра, очереди загрузок и интеграция с Android MediaScanner."),
          _devCard("Райская Ева", "Head of UI/UX Design", "Дизайн классической графитовой темы, мини-плеера и модальных окон."),
          _devCard("Сергей Александрович", "Core Media Engineer", "Парсинг видеопотоков без водяных знаков и обработка MP3."),
          _devCard("Артём Волков", "Security & QA Architect", "Управление системными разрешениями и оптимизация файлового кэша."),
          ...
          Center(
            child: Column(
              children: [
                ...
                const Text("Version 2.0.0 Pro Edition", style: TextStyle(fontSize: 11, color: ObanColors.textSecondary)),
              ],
            ),
          ),
